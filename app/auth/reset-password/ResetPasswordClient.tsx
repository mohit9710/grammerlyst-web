      ...
      <div className="relative max-w-md w-full bg-white rounded-3xl shadow-2xl p-10 text-center overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <input
            ...
            className="w-full px-5 py-4 rounded-2xl border-2 border-slate-100 focus:border-blue-500 outline-none"
          />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 text-white py-5 rounded-2xl font-black text-lg hover:bg-blue-700 disabled:opacity-60"
          >
