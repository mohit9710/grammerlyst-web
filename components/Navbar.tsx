      ...
      <div className="flex items-center gap-3">
        {!isAuth ? (
          <>
            <Link
              href="/auth/login"
              className="text-slate-600 font-bold hover:text-blue-600 px-4 transition text-sm md:text-base"
            >
              Sign In
            </Link>
            <Link
              href="/auth/signup"
              className="bg-blue-600 text-white px-5 py-2 md:px-6 md:py-2.5 rounded-xl font-bold hover:bg-blue-700 transition shadow-lg shadow-blue-100 text-sm md:text-base"
            >
              Get Started
            </Link>
          </>
